...
public:
    ...
    void cleanMeshes();
    // 更新
    void upDateMesh(TriMesh *mesh, openGLObject &object, Light *light, Camera *camera);
    void updateMeshes(Light *light, Camera *camera,int loc);

    //绘制阴影
    void drawShadow(TriMesh* mesh, openGLObject &object, Light *light, Camera* camera);
    void drawShadows(Light *light, Camera* camera);
